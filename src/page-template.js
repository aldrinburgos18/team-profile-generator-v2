  ...
  <body>
   <header>
    ...
    <main>
       ...
       </div>${generateEngineer(engineer)}${generateIntern(intern)}
     </div>
   </main>
  </body>
</html>`;
  ...
  for (var i = 0; i < engineer.length; i++) {
    ...
    <div class="card bg-primary" style="width: 18rem;">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Github: <a href="http://www.github.com/${engineer[i].github}" target="_blank">${engineer[i].github}</a></li>
      </ul>
    </div>`;
  }
  return engineerData;
